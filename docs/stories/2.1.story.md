...
- [ ] Task 1: Implement Drag and Drop File Handler (AC: 1, 3)
  - [ ] Add drag and drop event listeners to canvas container
  - [ ] Implement file validation (50MB max, supported types per specs)
  - [ ] Create file upload progress indicator with error messages
  - [ ] Handle multiple file drops with batch progress tracking
- [ ] Task 2: Create FileNode Component (AC: 2)
  - [ ] Design FileNode visual representation with file icon and name
  - [ ] Implement file type detection and appropriate icons
  - [ ] Add hover states and visual feedback
  - [ ] Ensure responsive design for different file name lengths
- [ ] Task 3: Integrate File Upload with Storage Service (AC: 3)
  - [ ] Extend existing StorageService for file node uploads
  - [ ] Generate unique file paths for uploaded files
  - [ ] Implement file integrity verification (checksum)
  - [ ] Handle upload errors with standardized error messages
  - [ ] Implement retry logic for failed uploads
- [ ] Task 4: Create FileNode Database Integration (AC: 4)
  - [ ] Extend NodeService to support FileNode creation
  - [ ] Implement FileNode data model according to architecture specs
  - [ ] Store file metadata (name, size, type, URL) in PostgreSQL
  - [ ] Ensure proper sessionId handling for public collaboration
- [ ] Task 5: Implement Node Movement Functionality (AC: 5)
  - [ ] Add drag handlers to FileNode component
  - [ ] Integrate with existing canvas pan/zoom system
  - [ ] Update node position in database on drag end
  - [ ] Implement smooth drag animations
- [ ] Task 6: Add File Download Functionality (AC: 6)
  - [ ] Implement click handler for file download
  - [ ] Use Supabase Storage public URLs for downloads
  - [ ] Add download progress indicator
  - [ ] Handle download errors gracefully
- [ ] Task 7: Unit Testing
  - [ ] Test drag and drop file handling with various file types
  - [ ] Test FileNode component rendering and interactions
  - [ ] Test file upload and storage integration with error scenarios
  - [ ] Test node creation and database operations
  - [ ] Test file download functionality
  - [ ] Test file validation (size limits, type restrictions)
